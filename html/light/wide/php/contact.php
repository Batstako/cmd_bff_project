...
if($_POST){
    ...
    if(isset($_POST['email'])) {
        $email_to = "stanislav.svetoslavov@gmail.com";
        $secondMail_to = "ivogluhchev@abv.bg";
        $gmail_to = "ivogluhchev@gmail.com";
      ...
      if(strlen($error_message) > 0) {
        ...
        @mail($secondMail_to, '=?UTF-8?B?'.base64_encode($email_subject).'?=', $email_message, $_header . $headers);
        @mail($gmail_to, '=?UTF-8?B?'.base64_encode($email_subject).'?=', $email_message, $_header . $headers);
