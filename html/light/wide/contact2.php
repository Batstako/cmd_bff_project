					...
					<div class="cell-9 top-menu">
						...
						<nav class="top-nav mega-menu">
							<ul>
								...
								<li><a href="cmd_portfolio_all.html"><i class="fa fa-gift"></i><span>Portfolio</span></a>
									<!--<ul>-->
								...
								<li><a href="cmd_group_details.html"><i class="fa fa-copy"></i><span>Продукти и услуги</span></a>
									<!--<ul>-->
								...
								<li><a href="#"><i class="fa fa-suitcase"></i><span>Партньори</span></a>
									<ul>
									...
									<ul>
										...
										<li><a href="#">Blog Small Image</a>
											<ul>
												...
												<li><a href="cmd_services.html">No side bar</a></li>
											</ul>
										</li>
								...
								<li class="selected"><a href="contact2.php"><i class="fa fa-leaf"></i><span>Контакти
							...
							<div class="row">
								...
								<div class="cell-4">
									...
									<ul class="footer-menu">
										...
										<li><a href="cmd_portfolio_all.html">Our Portfolio</a></li>
										<li><a href="FAQ.html">FAQ</a></li>
									</ul>
								</div>
								...
								<div class="cell-4">
									...
									<ul>
										...
										<li class="footer-contact"><i class="fa fa-map-marker"></i><span><a href="contact4.html#map_canvas">View our map</a></span></li>
									</ul>
								</div>
						...
						<div class="container">
							<div class="row">
								...
								<div class="copyrights cell-5">&copy; Авторски права <b>
										CMD-INTERNATIONAL</b> 2017. Всички права запазени. <span>
								<a href="cmd_privacy.html">Правна отговорност</a> | <a href="terms.html"></a></span></div>
