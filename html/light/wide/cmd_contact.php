...
<!--									<ul>-->
<!--										<li><a href="page-full.html">Kroma</a>-->
<!--											<!--<ul>-->
...
<!--											<!--</ul>-->
<!--										</li>-->
<!--										<li><a href="page-full2.html">Inter Aqua Advance</a>-->
<!--											<!--<ul>-->
...
<!--								<li>-->
<!--									<a href="cmd_privacy.html"><i class="fa fa-align-center"></i><span>Импресум</span></a>-->
<!--								</li>-->
							</ul>
						</nav>
...
<!--										<li><a href="blog.html">Our Blog</a></li>-->
								...
								<div class="cell-4">
									...
									<ul>
										...
										<li class="footer-contact"><i class="fa fa-map-marker"></i><span><a href="cmd_contact.php#enterCode">View our map</a></span></li>
									</ul>
								</div>
