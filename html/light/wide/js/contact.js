		...
		ajaxSubmit:function($this,action){
			...
			$.post(action, $('#cform').serialize(),
				function(data){
					...
					$('#message').html('<div class="cont-success center"><i class="fa fa-smile-o success-icon"></i><p class="congrats">Благодарим Ви</p><p class="congratsTxt">Вашето съобщение беше изпратено успешно, Ще се свържем с Вас скоро, ако искате да отидете на начална страница, натиснете долния линк!</p><div><a href="CMD_home.html" class="btn btn-large main-bg">Начало</a></div></div>');
